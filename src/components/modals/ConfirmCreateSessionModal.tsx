        ...
        <div className="p-6">
          <div className="text-center mb-6">
            <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaQuestionCircle className="w-8 h-8 text-blue-600 dark:text-blue-400" />
            </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6 border border-blue-200 dark:border-blue-800">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-sm text-blue-700 dark:text-blue-300">Tên:</span>
                <span className="text-sm font-medium text-blue-900 dark:text-blue-100 text-right max-w-xs truncate">
                  {quiz.name}
                </span>
              </div>
              <div className="flex items-center justify-between">
              ...
              {quiz.description && (
                <div className="pt-2 border-t border-blue-200 dark:border-blue-700">
                  ...
                  <p className="text-sm text-blue-900 dark:text-blue-100 mt-1 line-clamp-2">
                    {quiz.description}
                  </p>
                </div>
              )}
