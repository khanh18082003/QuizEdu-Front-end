...
const TeacherHome = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const classroomsWithStudentCount = await Promise.all(
        classroomsData.map(async (classroom) => {
          try {
            ...
            console.error(`Error loading students for classroom ${classroom.id}:`, error);
            return {
              ...classroom,
              studentCount: 0
            };
      ...
      // Calculate stats
      const activeClasses = classroomsWithStudentCount.filter(c => c.active).length;
  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="flex items-center rounded-lg bg-white p-6 shadow dark:bg-gray-800">
          <div className="mr-4">
            <FaChalkboard className="text-blue-500" size={24} />
          </div>
          <div>
        ...
        <div className="col-span-2 rounded-lg bg-white p-6 shadow dark:bg-gray-800">
          ...
          {classrooms.length === 0 ? (
            <div className="text-center py-8">
              <FaChalkboard className="mx-auto text-gray-400 text-4xl mb-4" />
              ...
              <table className="w-full">
                ...
                <tbody>
                  {classrooms.map((classroom) => (
                    <tr key={classroom.id} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="py-4 text-gray-600 dark:text-gray-300">
                        <div className="flex items-center gap-1">
                          <FaUsers size={12} />
                          {classroom.studentCount !== undefined ? classroom.studentCount : '...'}
                        </div>
                      </td>
                      <td className="py-4 text-gray-600 dark:text-gray-300 text-xs">
      ...
      <div className="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Button
            ...
            className="h-auto justify-start p-4 flex items-center"
          >
