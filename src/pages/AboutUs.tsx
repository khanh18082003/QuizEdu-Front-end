    ...
    <div className="mx-auto max-w-3xl text-center">
      ...
      <div className="mb-12 grid gap-8 md:grid-cols-3">
        <div className="flex flex-col items-center">
          <FaLightbulb className="mb-2 text-3xl text-[var(--color-gradient-to)]" />
          <h3 className="mb-1 font-bold dark:text-white">Our Mission</h3>
          <p className="text-sm text-[#232946] dark:text-gray-300">
            Empower students and teachers with innovative tools for interactive
            learning and assessment.
          </p>
        </div>
        <div className="flex flex-col items-center">
          <FaUsers className="mb-2 text-3xl text-[var(--color-gradient-to)]" />
        ...
        <div className="flex flex-col items-center">
          <FaHeart className="mb-2 text-3xl text-[var(--color-gradient-to)]" />
