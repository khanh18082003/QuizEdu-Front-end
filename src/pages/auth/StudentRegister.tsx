  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      try {
        ...
        // Make API call to register student using the service
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="mb-4 w-full">
                ...
                <select
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  className={`w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-gray-700 focus:border-[var(--color-gradient-from)] focus:ring-2 focus:ring-[var(--color-gradient-from)]/20 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 ${touched.level && errors.level ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : ""} `}
                  required
                >
